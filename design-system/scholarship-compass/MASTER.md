...
**Project:** Scholarship Compass
**Generated:** 2026-09-24 14:46:27
**Category:** General
...
| ---------------- | --------- | -------------------------- |
| Primary          | `#0B4CC4` | `--color-primary`          |
| On Primary       | `#FFFFFF` | `--color-on-primary`       |
| Secondary        | `#1262E2` | `--color-secondary`        |
| On Secondary     | `#FFFFFF` | `--color-on-secondary`     |
| Accent/CTA       | `#0B4CC4` | `--color-accent`           |
| On Accent/CTA    | `#FFFFFF` | `--color-on-accent`        |
| Background       | `#F7F9FC` | `--color-background`       |
| Foreground       | `#0B172A` | `--color-foreground`       |
| Card             | `#FFFFFF` | `--color-card`             |
| Card Foreground  | `#0B172A` | `--color-card-foreground`  |
| Muted            | `#E8F1FF` | `--color-muted`            |
| Muted Foreground | `#56657A` | `--color-muted-foreground` |
| Border           | `#DBE3EE` | `--color-border`           |
| Destructive      | `#DC2626` | `--color-destructive`      |
| On Destructive   | `#FFFFFF` | `--color-on-destructive`   |
| Ring             | `#1262E2` | `--color-ring`             |

**Color Notes:** User-directed trust blue, navy hierarchy, neutral surfaces, and restrained success green. Avoid purple AI gradients.
